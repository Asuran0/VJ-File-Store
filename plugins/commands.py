...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            InlineKeyboardButton('💝 sᴜʙsᴄʀɪʙᴇ Telegram ᴄʜᴀɴɴᴇʟ', url='https://t.me/PR_CineHub')
            ],[
            InlineKeyboardButton('🔍 Movie Req ɢʀᴏᴜᴘ', url='https://t.me/+oV5evQP6bv41MTI1'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/PR_CineHub')
            ],[
...
# Ask Doubt on telegram @KingVJ01
    ...
    if not files_:
        ...
        try:
            ...
            title = '@PR_CineHub  ' + ' '.join(filter(lambda x: not x.startswith('[') and not x.startswith('@'), file.file_name.split()))
...
# Ask Doubt on telegram @KingVJ01
        ...
        buttons = [[
            InlineKeyboardButton('💝 Telegram ᴄʜᴀɴɴᴇʟ', url='https://t.me/PR_CineHub')
            ],[
            InlineKeyboardButton('🔍 Movie Request', url='https://t.me/+oV5evQP6bv41MTI1'),
            InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/PR_CineHub')
            ],[
